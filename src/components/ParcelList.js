...
class ParcelList extends React.Component {
    ...
    render() {
        const {selectedParcelAttr} = this.props;
        return (
            <div>
                ...
                <Table
                    ...
                    dataSource={this.props.parcels} columns={
                    Object.keys(data)
                        .map(k => ({
                            title: k,
                        ...
                        },
                        {
                            ...
                            key: "delete",
                            render: (index, record, ind) => (
                            <Popconfirm placement="topLeft" title="Êtes-vous sure?" onConfirm={()=>{
                            ...
                            render: (index, record, ind) => (
                                this.state.edit === ind ?
                                    ...
                                    <div>
                                        ...
                                        >{this.props.editingParcelSuccess && this.state.success === ind ? <Icon type="check" style={{color: "green"}}/> : ""}</Button>
                                    </div>)
                        }
                    ])
                }/>
